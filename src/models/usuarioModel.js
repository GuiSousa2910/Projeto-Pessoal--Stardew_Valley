...
function cadastrar(nome, email, senha, nomeFazenda) {
    ...
    // INSERT INTO jogoCC (idJogoCC, fkFazendeiro, pontosCC, qntVerde, qntAmarelo, qntRosa, qntRoxo, qntBranco, qntLaranja, hora) VALUES ('${jogoCC.id}','${jogoCC.idFazendeiro}','0', '0', '0', '0', '0', '0', '0', DATE_FORMAT(CURDATE(), '%d-%m'));
